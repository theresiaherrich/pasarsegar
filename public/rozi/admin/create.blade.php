            ...
            <div class="card-body">
              <form action="{{ route('admin.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control @error('tour') is-invalid @enderror" id="tour" name="tour">
                  @error('tour')
               ...
               @endforeach
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control @error('days') is-invalid @enderror" id="days" name="days">
                  @error('days')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
