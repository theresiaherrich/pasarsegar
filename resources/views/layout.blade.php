...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@500&family=Montserrat:wght@700&display=swap"
        rel="stylesheet">
...
<body>
    ...
    <nav
        class="navbar navbar-expand-lg shadow-lg sticky-top"style="background-image:url('{{ asset('img/bgnv.jpg') }}')">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav  mb-2 mb-lg-0 ms-auto py-2">
                    ...
                    <li class="nav-item px-3">
                        <a class="nav-link " href="#"><i class="bi bi-search"></i>&nbsp;&nbsp;<span
                                class="navt">Cari</span></a>
                    </li>
                    <li class="nav-item px-3">
                        <a class="nav-link " href="{{ route('cart.index') }}"><i
                                class="bi bi-cart-fill"></i>&nbsp;&nbsp;<span class="navt">Keranjang</span></a>
                    </li>
