        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card shadow bg-white  ">
                    <h4 class="text-center mt-4 display-6">Chekout</h4>
                    <hr>

                    <div class="row px-5 py-3">
                        <h3 class="mb-3">Ringkasan Belanja
                        </h3>
                        <div class="col-lg-6">
                            <h5>Subtotal harga (1)</h5>
                        </div>
                        <div class="col-lg-1">
                            <h5>:</h5>
                        </div>
                    ...
                    <div class="p-3 mb-3">
                        <center>
                            <button class="btn btn-success btn-lg " style="width: 100%">Chekout</button>
                    </div>
                    </center>
                </div>
            </div>
