                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @endif
                                <form action="{{ route('dataproduk.update', $prod->id) }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="mb-3">
                                                <label class="form-label" for="nama_produk">Nama Produk</label>
                                                <input type="text" class="form-control" name="nama_produk"
                                                    id="nama_produk" value="{{ old('nama_produk', $prod->nama_produk) }}" placeholder="Masukan Nama Produk" required>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="kategori_id" id="kategori_id" class="form-control">
                                                                ...
                                                                <option value="{{$kategori->id}}" {{($prod->kategori_id == $kategori->id) ? 'selected' : ''}}>{{ $kategori->nama_kategori }}</option>
                                                                @endforeach
                                                              </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="stock" name="stock" value="{{ old('stock', $prod->stock) }}"
                                                    ...
                                                    <div class="col-lg-3 col-sm-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <input type="text" class="form-control"
                                                                name="satuan" id="satuan" value="{{ old('satuan', $prod->satuan) }}"
                                                    ...
                                                    <div class="col-lg-6 col-sm-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="input-group has-validation mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                name="harga" id="harga" value="{{ old('harga', $prod->harga) }}" placeholder="Masukan Harga"
                                                                    aria-label="Price"
