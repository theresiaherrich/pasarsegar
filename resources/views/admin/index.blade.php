...
<!-- /.modal -->
                                                        ...
                                                        <tbody>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                                                            <img src="{{ asset('template/themesbrand.com/velzon/html/default/assets/images/products/img-1.png') }}" alt="" class="img-fluid d-block" />
                                                                        </div>
                                                                        <div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                                                            <img src="{{ asset('template/themesbrand.com/velzon/html/default/assets/images/products/img-2.png') }}" alt="" class="img-fluid d-block" />
                                                                        </div>
                                                                        <div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                                                            <img src="{{ asset('template/themesbrand.com/velzon/html/default/assets/images/products/img-3.png') }}" alt="" class="img-fluid d-block" />
                                                                        </div>
                                                                        <div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                                                            <img src="{{ asset('template/themesbrand.com/velzon/html/default/assets/images/products/img-4.png') }}" alt="" class="img-fluid d-block" />
                                                                        </div>
                                                                        <div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                                                            <img src="{{ asset('template/themesbrand.com/velzon/html/default/assets/images/products/img-5.png') }}" alt="" class="img-fluid d-block" />
                                                                        </div>
                                                                        <div>
    ...
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
        ...
        <div class="offcanvas-footer border-top p-3 text-center">
            <div class="row">
                ...
                <div class="col-6">
                    <a href="{{ asset('template/themesbrand.com/velzon/html/default/https://1.envato.market/velzon-admin') }}" target="_blank" class="btn btn-primary w-100">Buy Now</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- apexcharts -->
    <script src="{{ asset('template/themesbrand.com/velzon/html/default/assets/libs/apexcharts/apexcharts.min.js') }}"></script>

    <!-- Vector map-->
    <script src="{{ asset('template/themesbrand.com/velzon/html/default/assets/libs/jsvectormap/js/jsvectormap.min.js') }}"></script>
    <script src="{{ asset('template/themesbrand.com/velzon/html/default/assets/libs/jsvectormap/maps/world-merc.js') }}"></script>

    <!--Swiper slider js-->
    <script src="{{ asset('template/themesbrand.com/velzon/html/default/assets/libs/swiper/swiper-bundle.min.js') }}"></script>

    <!-- Dashboard init -->
    <script src="{{ asset('template/themesbrand.com/velzon/html/default/assets/js/pages/dashboard-ecommerce.init.js') }}"></script>
...
<!-- Mirrored from themesbrand.com/velzon/html/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Feb 2023 03:16:34 GMT -->
</html>
