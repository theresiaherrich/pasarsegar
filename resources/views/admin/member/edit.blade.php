                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @endif
                                <form action="{{ route('members.update', $mem->id )}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="mb-3">
                                                <label class="form-label" for="nama">Nama</label>
                                                <input type="text" class="form-control" name="nama"
                                                    id="nama" value="{{ old('nama', $mem->nama) }}" placeholder="Masukan Nama" required>
                                                <div class="invalid-feedback">Masukan Nama</div>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="role">Role</label>
                                                <input type="text" class="form-control" name="role"
                                                    id="role" value="{{ old('role', $mem->role) }}" placeholder="Masukan Role" required>
                                                <div class="invalid-feedback">Masukan Role</div>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="telp">Telp</label>
                                                <input type="text" class="form-control" name="telp"
                                                    id="telp" value="{{ old('telp', $mem->telp) }}" placeholder="Masukan Telp" required>
                                                <div class="invalid-feedback">Masukan Telp</div>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="twitter">Twitter</label>
                                                <input type="text" class="form-control" name="twitter"
                                                    id="twitter" value="{{ old('twitter', $mem->twitter) }}" placeholder="Masukan Twitter" required>
                                                <div class="invalid-feedback">Masukan Twitter</div>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="insta">Instagram</label>
                                                <input type="text" class="form-control" name="insta"
                                                    id="insta" value="{{ old('insta', $mem->insta) }}" placeholder="Masukan Instagram" required>
                                                <div class="invalid-feedback">Masukan Instagram</div>
                                            </div>
