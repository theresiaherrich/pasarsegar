                                    ...
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-sm-auto">
                                            <div class="d-flex flex-wrap align-items-start gap-2">
                                                ...
                                                <a href="{{ route('members.create')}}" class="btn btn-success add-btn"><i
                                                        class="ri-add-line align-bottom me-1"></i> Add Anggota</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <table class="table align-middle" id="customerTable">
                                                <thead class="table-light text-muted">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="telp">Telp</th>
                                                        <th class="sort" data-sort="twitter">Twitter</th>
                                                        <th class="sort" data-sort="insta">Instagram</th>
                                                ...
                                                <tbody class="list form-check-all">
                                                    ...
                                                    @forelse ($mem as $row)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if ($row->foto != null)
                                                                    <img src="{{ asset('storage/member/'.$row->foto) }}"
                                                            ...
                                                            <td>
                                                                <a href="{{ route('members.edit', $row->id) }}" class="btn btn-sm btn-primary mr-2 mb-2">
                                                                  Edit
                                                                </a>
                                                                <form onsubmit="return confirm('Apakah Anda Yakin ?');"  action="{{ route('members.destroy', $row->id) }}" method="post" style="display:inline;">
                                                                  @csrf
                                                                  {{ method_field('delete') }}
